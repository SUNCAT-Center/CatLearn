...
class data_process(object):
    ...
    def data_pickup(self, new_data, batchfarm=False):
        """data_pickup picks out data from SQL.

        Parameters
        ----------
        new_data : string
            Re-use data from earlier run, or use new data.
        """
        if not batchfarm:
        ...
        if new_data:
            ...
            hv.split_index(min_split=self.min_split, max_split=self.max_split)
    ...
    def globalscaling(self, globalscaledata):
