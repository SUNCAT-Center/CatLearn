...
#fpv_new = AdsorbateFingerprintGenerator(mols='mol.db', bulks='ref_bulks_k24.db')

#training and validation data
train_cand = fpv_train.db2surf_info()#fname='metals.db', selection=['Al=0','series=H','layers=5','facet=1x1x1','kpts=4x6','PW=500','PSP=gbrv1.5pbe'])
print(len(train_cand), 'training candidates')

#test data (no Ef)
#new_cand = fpv_new.db2atoms_info(fname='input_mslab.db', selection=['id>400','Al=0','series=H','layers=5','facet=1x1x1', 'supercell=3x2'])
